...
export default function Content() {
  const id = '6884cbedf71ec698fd833eb7'; // Your football school document ID
//   const [data, setData] = useState<PageProps | null>(null);
  ...
  const [coach, setCoach] = useState<{ name: string; phone: string; email: string }>({ name: '', phone: '', email: '' });
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-lg font-semibold text-gray-700">Mladinske Ekipe - U15</h2>
