...
export default function Content() {
  const id = '6885bbf58718432e43975733'; // Your football school document ID
//   const [data, setData] = useState<PageProps | null>(null);
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const res = await axios.get(`/api/klub/${id}`);
        const item = res.data;
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-lg font-semibold text-gray-700">Klub - Pravilniki</h2>
