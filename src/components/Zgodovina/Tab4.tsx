...
export default function Tab4() {
    ...
    <div className="w-full p-4 flex h-fit gap-8 flex-col justify-center items-center max-w-5xl">
        ...
        { photoHistory.length === 0 ? (
            ...
            { photoHistory.map((key : number, item : PhotoHistoryItem) => {
                return (
                    <>
                     {/* Text: Content */}
                    <div key={key} className="flex items-start justify-center w-full p-4 py-0 flex-col poppins text-black max">
                    ...
                    {/* Image: Content */}
                    <div key={key} className="flex items-center justify-start w-full gap-4 flex-wrap -mt-10">
