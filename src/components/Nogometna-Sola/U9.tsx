...
export default function U9() {
    return(<>
    <div className="w-full p-4 flex h-fit gap-8 flex-col justify-center items-center">
        {/* Left: Image */}
        ...
        <div className="flex items-start justify-center w-full p-4 py-0 flex-col poppins">
            <div className="flex flex-col border-b-2 border-gray-200 items-start justify-start w-full h-fit pb-5 text-black uppercase">
                ...
                <ul className="list-disc ml-6 space-y-1 text-gray-800 mb-4 font-light">
                    <li>V ponedeljek (14.8.) začnemo s počitniškimi treningi, ki bodo potekali od 16h do 17.30.</li>
                ...
                <p className='mb-4'>NA TURNIRJE HODIMO V KLUBSKI OPREMI!</p>
                ...
                <ul className="list-disc ml-6 space-y-1 text-gray-800 mb-4 font-light">
                    ...
                    <li>tretjih 5 vaj navajanja na žogo</li>
                    <li>četrtih 5 vaj navajana na žogo</li>
                </ul>
            ...
            <div className='w-full h-50 p-2 px-5 flex gap-12 pb-0 items-end justify-center '>
                <div className='relative w-1/2 max-w-96 p-1 h-40 bg-gray-200 flex items-end justify-center rounded-xs'>
